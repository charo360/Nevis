...
### 3. **Anthropic Claude (Required for Website Analysis)**
```
ANTHROPIC_API_KEY=your-anthropic-api-key
```

### 4. **OpenAI (Required for Revo 1.5 & Assistants)**
```
...
### 7. **SendGrid Email (For auth emails)**
```
...
### 10. **Vertex AI Credentials (As JSON string)**
```
